 <nav class="navbar navbar-expand-lg  shadow sticky-top" style="background-color: blue;">
        <div class="container">
            <a class="navbar-brand fw-bold text-white" href="{{ route('fishes.index') }}">
                <img src="{{asset('app-logo.png')}}" alt="gambar hiu" style="width: 40px; height: auto; border-radius: 10px">
                FISH IT
            </a>
